...
static const QString CORE_VERSION = "3.1.1-0";
...
/* Q_INVOKABLE */ void ControllerCore::loadLibrary()
{
    ...
    loadFolder(entries, _pathSkz + "/run");
                                                              ...
                                                              const QString & name)
{
    ...
    WUnzipper::extract(filePath, _pathSkz);
